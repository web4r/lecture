<h1 class="text-center">List materi yang di pelajari</h1>
...
<div class="row mt-5">
	<div class="col-md-12">
		...
		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
			<i class="fa fa-plus"></i> Materi Kelas
		</button>
		...
		<div class="table-responsive mt-2">
			<table class="table" id="webTable"> 
				...
				<tbody>
					<?php foreach($classMateriLecture as $materi) : ?>
					<tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Form Penambahan Materi</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
		<?php echo form_open('Backend/WebClass/saveMateri/'.$classMateri->id_class) ?>
			<div class="form-group">
				<?php 
					...
					$data = array(
						...
						'type' => 'text',
						'class' => 'form-control',
						'placeholder' => 'Contoh : Perkenalan HTML'
					);
